    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl">
        ...
        <form action="{{ $formRoute }}" method="POST" class="space-y-6">
            ...
            <div class="pt-4 border-t border-gray-200">
                <button type="submit" 
                        class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium w-full sm:w-auto flex items-center justify-center gap-2"
                        {{ $templates->count() === 0 ? 'disabled' : '' }}>
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                    </svg>
                    Generate {{ strtoupper($jenis) }}
                </button>
            </div>
        </form>
    </div>
