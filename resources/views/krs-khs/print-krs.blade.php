...
<head>
    ...
    <style>
        ...
        .print-btn { padding: 10px 20px; background: #16a34a; color: #fff; border: none; border-radius: 5px; cursor: pointer; margin-bottom: 20px; font-weight: bold; }
    </style>
</head>
<body>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">Belum ada data mata kuliah yang disetujui pada KRS semester ini.</td>
                </tr>
            @endforelse
            <tr>
    ...
    <div class="footer">
        ...
        <div class="footer-right">
            <p>__________, {{ date('d F Y') }}<br>Mahasiswa</p>
            <br><br><br>
            <p><strong>{{ $mahasiswa->nama }}</strong><br>NIM: {{ $mahasiswa->nim }}</p>
        </div>
    </div>
