...
<head>
    ...
    @php
        ...
        $appName = $appInfo['name'] ?: env('APP_NAME', 'SIAKAD ITAMA');
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                            @php
                                ...
                                $appNameBody = $appInfoBody['name'] ?: env('APP_NAME', 'SIAKAD ITAMA');
                            ...
                            @else
                                <img src="{{ asset('images/logo-itama.png') }}" alt="{{ $appNameBody }}" class="h-10 w-auto object-contain">
                            @endif
