...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Grafik presensi per mata kuliah per semester</p>
        </div>
    </div>

    <!-- Filter Semester -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="{{ route('admin.statistik-presensi.index') }}" class="flex items-end gap-4">
            <div class="flex-1">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($data as $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item['dosen'] }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-4 text-center text-gray-500">Tidak ada data presensi</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
