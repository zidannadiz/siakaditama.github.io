...
@section('title', 'Daftar Pelanggaran - ' . $exam->judul)

@section('content')
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Daftar Pelanggaran Ujian</h1>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
        <p class="text-blue-800">Tidak ada mahasiswa yang melakukan pelanggaran pada ujian ini.</p>
    </div>
    @else
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('dosen.exam.violation-detail', ['exam' => $exam, 'session' => $session]) }}" 
