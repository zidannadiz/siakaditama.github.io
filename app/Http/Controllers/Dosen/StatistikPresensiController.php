...
class StatistikPresensiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($selectedSemesterId) {
            // Ambil jadwal kuliah dosen untuk semester yang dipilih
            $jadwalKuliahs = JadwalKuliah::with(['mataKuliah'])
        ...
        return view('dosen.statistik-presensi.index', compact('semesters', 'selectedSemesterId', 'data'));
    }
}
