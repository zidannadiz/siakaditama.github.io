              ...
              GridView.count(
                ...
                children: [
                  ...
                  _MenuCard(
                    ...
                    icon: Icons.schedule,
                    color: Colors.pink,
                    onTap: () => context.push('/admin/jadwal-kuliah'),
                  ),
                  _MenuCard(
                  ...
                  _MenuCard(
                    ...
                    icon: Icons.calendar_today,
                    color: Colors.indigo,
                    onTap: () => context.push('/admin/kalender-akademik'),
                  ),
                  _MenuCard(
                  ...
                  _MenuCard(
                    ...
                    color: Colors.deepPurple,
                    onTap: () => context.push('/admin/laporan/pembayaran'),
                  ),
                  _MenuCard(
                    title: 'Laporan Akademik',
                    icon: Icons.school,
                    color: Colors.blueGrey,
                    onTap: () => context.push('/admin/laporan/akademik'),
                  ),
                  _MenuCard(
                    title: 'Statistik Presensi',
                    icon: Icons.bar_chart,
                    color: Colors.cyan,
                    onTap: () => context.push('/admin/statistik-presensi'),
                  ),
                  _MenuCard(
